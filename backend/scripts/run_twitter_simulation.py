"""JevFish entrypoint for the original Twitter MiroFish/OASIS simulator.

The untouched upstream implementation lives in run_twitter_simulation_legacy.py.
This wrapper installs the Jev System-One action layer before running it.
"""

import asyncio

import run_twitter_simulation_legacy as legacy
from jevfish_live_metrics import install_live_metrics
