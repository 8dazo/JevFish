<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">JEVFISH</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/8dazo/JevFish" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="/jevfish-logo.webp" alt="JevFish Logo" class="hero-logo" />
          </div>
